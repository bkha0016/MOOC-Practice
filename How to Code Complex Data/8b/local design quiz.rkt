...
(define R3 (list "Eugenie" "Gabriela" "Sharon" "Aleksandra" "Stever"))
...
(define (roster-match lom1 lom2)
  (cond [(and (empty? lom1) (empty? lom2)) true]
        [(empty? lom1) false]
        [(empty? lom2) false]
        [else (roster-match (rest lom1) (rest lom2))]))
...
(define (match-list lom1 lom2)
  (cond [(and (empty? lom1) (empty? lom2)) empty]
        [else (cons (make-match (first lom1) (first lom2)) (match-list (rest lom1) (rest lom2)))]))
